...
$sql_user = "SELECT username FROM tbl_admin WHERE admin_id = '$admin_id' ;";
...
<body>
  ...
  <div class="header">
    ...
    <a class="header_left" href="index.php" style="color: white;"> รายการสั่งซื้อ </a>

    <a class="header_left" href="import_product_list.php" style="color: white;"> จัดการสต็อก </a>

    <a class="header_left" href="product.php" style="color: white;"> รายการสินค้า </a>

    <a class="header_left" href="problem.php" style="color: white;"> รายงานปัญหา </a>

    <h4 class="text-center" style="margin-right: 410px;">พรสำราญ</h4>

    <li class="dropdown">
      <a class="header_right" data-toggle="dropdown">
        <i class="fa fa-user" aria-hidden="true"></i> <?php echo $row_user['username']; ?>
      </a>
      <ul class="dropdown-menu dropdown-alerts">
        <li>
          <a onclick="LogoutConfirm();" class="dropdown-item">
